...
def validate_input(state: AgentState) -> dict[str, Any]:
    ...
    if not tickers:
        return {
            ...
            "tool_calls_log": [], "messages": [], "report": None,
        }
...
async def run_research(
    ...
    logger.info("run_research: invoking graph query='%s' tickers=%s depth=%s",
                query, tickers, research_depth)
